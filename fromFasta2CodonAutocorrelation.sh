...
echo "##" 
src/codon_autocorrelation_multiple_sequences.py $input_fasta DNA

# 2. Build merged from total_codons and paired_codons
echo "##" 
echo "## STEP 2: Merging total_codons and paired_codons files..."
echo "##" 
src/parse_codon_autocorrelation_output.sh $input_fasta.paired_codons $input_fasta.total_codons

# 3. Fix merged with missing pairs
echo "##" 
echo "## STEP 3: Add missing codon pairs to merged file..."
echo "##" 
src/fix_merged_file_codon_autocorrelation_counts.sh $input_fasta.codon_counts.merged;                                                                     

# 4. Build R code with specific input and get SDEVS and plots
echo "##" 
echo "## STEP 4: Computing codon autocorrelation and RSCPU values..."
cat src/parse_codon_autocorrelation_merged.R | sed "s/INPUTFILE/$input_fasta.codon_counts.merged.FIXED/g" > $input_fasta.codon_counts.merged.FIXED.R;
echo "##" 
