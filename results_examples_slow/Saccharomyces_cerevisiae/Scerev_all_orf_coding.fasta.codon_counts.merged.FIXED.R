...
matrix_obs<-from_codonFIXED_to_matrix_FINAL("Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED")
...
# Plots
pdf(file="Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_plots.pdf", height=7, width=7)
...
write.table(as.vector(t(arg_sdev)), "Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_arg_sdev.vector.txt", row.names=F)

sink("Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_sdevs.txt",append=FALSE, split=FALSE)
ala_sdev
arg_sdev
gly_sdev
ile_sdev
...
pdf(file="Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_plots_byAA.pdf", height=7, width=7)
...
#Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED<-c(ala_rscpu1_vector, arg_rscpu1_vector, gly_rscpu1_vector, ile_rscpu1_vector, leu_rscpu1_vector, ser_rscpu1_vector, pro_rscpu1_vector, thr_rscpu1_vector, val_rscpu1_vector)  # all_all_vector
Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED<-c(all_rscpu1_vector)
write.table(data.frame(Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED), "Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_rscpu_vector_way1.txt", row.names=T,quote=FALSE)

#Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED<-c(ala_rscpu2_vector, arg_rscpu2_vector, gly_rscpu2_vector, ile_rscpu2_vector, leu_rscpu2_vector, ser_rscpu2_vector, pro_rscpu2_vector, thr_rscpu2_vector, val_rscpu2_vector)  # all_all_vector
Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED<-c(all_rscpu2_vector)
write.table(data.frame(Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED), "Scerev_all_orf_coding.fasta.codon_counts.merged.FIXED_rscpu_vector_way2.txt", row.names=T, quote=FALSE)
